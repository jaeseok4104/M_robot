...
void main(void)
{
    ...
    while(1)
    {
        ...
        if(currentV_R==0 && currentV_L==0) TIMER0_TIME_print = 0;
        ...
        goal_currentV_R = (float)(goal_current_R/(152.788*Gearratio));
        goal_currentV_L = (float)(-goal_current_L/(152.788*Gearratio));
