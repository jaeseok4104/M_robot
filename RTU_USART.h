...
#define MOTOR_DRIVE_VELOCITY_CEL_TIME 0.75
#define MOTOR_CONT_VELOCITY_MAX_SPEED 0.5

#define MOTOR_DRIVE_ANGULAR_CEL_TIME 0.33
#define MOTOR_CONT_ANGULAR_MAX_SPEED 1.5
